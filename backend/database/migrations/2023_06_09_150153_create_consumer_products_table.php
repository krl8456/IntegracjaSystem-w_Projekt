...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('consumer_products', function (Blueprint $table) {
            ...
            $table->decimal('2021 M01', 8, 5);
            $table->decimal('2021 M02', 8, 5);
            $table->decimal('2021 M03', 8, 5);
            $table->decimal('2021 M04', 8, 5);
            $table->decimal('2021 M05', 8, 5);
            $table->decimal('2021 M06', 8, 5);
            $table->decimal('2021 M07', 8, 5);
            $table->decimal('2021 M08', 8, 5);
            $table->decimal('2021 M09', 8, 5);
            $table->decimal('2021 M10', 8, 5);
            $table->decimal('2021 M11', 8, 5);
            $table->decimal('2021 M12', 8, 5);
            $table->decimal('2022 M01', 8, 5);
